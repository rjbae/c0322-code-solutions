...
function renderPokemon(pokemon) {
  ...
  var headingText = document.createTextNode(pokemon.name);
  cardText.appendChild(headingTwo);
  headingTwo.appendChild(headingText);

  var headingThree = document.createElement('h3');
  var headingTextThree = document.createTextNode(pokemon.number);
  cardText.appendChild(headingThree);
  headingThree.appendChild(headingTextThree);
